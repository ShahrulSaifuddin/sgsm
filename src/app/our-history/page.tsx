...
/**
 * Editorial reading layout: a narrow (`size="sm"`, ~72ch via `.prose-sgsm`)
 * centered column with a generous eyebrow/title banner up top — closer to a
 * long-form article than a marketing page, matching nearly a century of
 * society history.
 */
export default function OurHistoryPage() {
  ...
  return (
    <article>
      <PageHeader eyebrow="Introduction · Est. 1931" title={doc.title} subtitle={doc.description} />
