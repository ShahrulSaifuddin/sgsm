...
export type NewsRawSearchParams = { page?: string; category?: string };

/**
 * Async data boundary for `/news`. Rendered inside a `<Suspense>` from the
 ...
 */
export async function NewsResults({ searchParams }: { searchParams: Promise<NewsRawSearchParams> }) {
